...
implements DOIConnector
{
            ...
            throws DOIIdentifierException
    {
        ...
        try
        {
            ...
            /* 
            log.info("Going to send HTTP request of type " + req.getMethod() + ".");
            log.info("Will be send to " + req.getURI().toString() + ".");
            if (req instanceof HttpEntityEnclosingRequestBase)
            {
            	log.info("Request contains entity!");
            	...
            	log.info("Request contains no entity!");
            }
            log.debug("The request got http status code {}.", Integer.toString(statusCode));
            if (null == content)
            {
            	log.info("The response did not contain any answer.");
            } else {
            	log.info("DataCite says: {}", content);
            }
		      */       
